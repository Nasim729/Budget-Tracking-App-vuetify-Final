<template>
  <v-container class="fill-height" fluid>
    <v-row>
      <v-col cols="auto">
        <div class="profile-info">
          <img :src="profilePicture" alt="Profile Picture" width="75" height="75" />
          <p class="center-text">{{ userStore.name }}</p>
        </div>
      </v-col>
      <v-col>
        <BalanceDisplay :financialData="financialData" :currency="selectedCurrency" />
          ...
          <v-col cols="12" md="8" lg="6">
            <v-card class="mx-auto" elevation="10">
              <v-card-title class="headline">
                ...
                <v-btn color="primary" @click="showSettingsDialog" absolute top right style="right: 10px; top: 10px;">Settings</v-btn>
              </v-card-title>
              <v-card-text>
                <v-tabs v-model="tab">
                  ...
                  <v-tab value="budget">Budget Planner</v-tab>
                ...
                <v-window v-model="tab">
                    ...
                    <v-card flat>
                      ...
                      <v-card-text>
                        <div>
                          ...
                          <p>Current Balance: {{ balance }} {{ selectedCurrency.value }}</p>
                      ...
                      <v-card-text>
                        <v-form>
                          <v-row>
                            ...
                            <v-col cols="12" sm="3">
                              <v-file-input label="Profile Picture" v-model="profilePicture" @change="onProfilePictureChange" />
                            </v-col>
                            <v-col cols="12" sm="6">
                              <v-text-field
                                v-model="userStore.profession"
                                label="Profession"
                                type="text"
                                required
                              ></v-text-field>
                        ...
                        <div v-if="showSummary">
                          ...
                          <p>Profession: {{ userStore.profession }}</p>
                  ...
                  <v-window-item value="analytics">
                    <v-card flat>
                      ...
                      <v-card-text>
                        <AnalyticsChart :income="currentMonthIncome" :expenses="currentMonthExpenses" />
                      </v-card-text>
                    </v-card>
                  </v-window-item>
                  <v-window-item value="budget">
                    <v-card flat>
                      <v-card-title>Budget Planner</v-card-title>
                      <v-card-text>
                        <BudgetPlanner />
                      </v-card-text>
                    </v-card>
                  ...
                  <v-window-item value="help">
                    <v-card flat>
                      ...
                      <v-card-text>
                        <a href="https://www.loom.com/share/0113968301d6430f80c59aadae572567" target="_blank">Watch the video instruction to use the app</a>
                      </v-card-text>
                    </v-card>
                  </v-window-item>
                </v-window>
    ...
    <v-dialog v-model="showSettings" width="500" absolute top>
      <Settings />
    </v-dialog>
  </v-container>
</template>
